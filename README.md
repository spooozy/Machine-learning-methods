...
4. **Binary classification & Decision Trees** based on logistic regression, SVM, and CART models. CART is optimized using minimal cost-complexity pruning. Code is in `Classification.ipynb`. Dataset used: `loan_data.csv`
